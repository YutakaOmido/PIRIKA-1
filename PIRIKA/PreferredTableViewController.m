//
//  PreferredTableViewController.m
//  PIRIKA
//
...
@interface PreferredTableViewController ()

@end

@implementation PreferredTableViewController
{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        if([conn openSocket]){
            ...
            [conn writeData:mes protocol:4003];
...
{
    static NSString *CellIdentifier = @"Prederred";
    ...
    // Configure the cell...
    if (_result) {
        cell.textLabel.text = [NSString stringWithFormat:@"Preferred %d",indexPath.row+1];
    }else if(_complete){
