...
public class ProlMain implements Prol{
	 ...
	 * @return
	 */
	public Boolean init(String LMAPath, String truthvaluePath, String filepath){
		File[] init = new File[2];
		String sep = File.separator;

		init[0] = new File(LMAPath);
        init[1] = new File(truthvaluePath);
	...
	public static Boolean checkEALPGrammer(String contents,String lmaPath) throws ParserException{
		String sep = File.separator;
		File lma = new File(lmaPath);
		BufferedReader br = null;
