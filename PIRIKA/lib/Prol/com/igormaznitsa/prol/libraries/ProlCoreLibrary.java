 ...
 *
 * ---------------------------------
 * This file changed by Yuki Katsura.(kryptos.nv@gmail.com)
 * April,2014
 * ---------------------------------
 */
...
public final class ProlCoreLibrary extends ProlAbstractLibrary {
    ...
    @Determined
    public boolean predicateArithEqu(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateTermLess(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateTermLessOrEqu(final Goal goal, final TermStruct predicate) {
        return predicate.getElement(0).termComparsion(predicate.getElement(1)) <= 0;
    }
    
    @Predicate(Signature = "@>/2", Template = {"?term,?term"}, Reference = "Term greater than")
    @Determined
    public boolean predicateTermMore(final Goal goal, final TermStruct predicate) {
        return predicate.getElement(0).termComparsion(predicate.getElement(1)) > 0;
    }
    
    @Predicate(Signature = "@>=/2", Template = {"?term,?term"}, Reference = "Term greater than or equal to.")
    @Determined
    public boolean predicateTermMoreOrEqu(final Goal goal, final TermStruct predicate) {
        return predicate.getElement(0).termComparsion(predicate.getElement(1)) >= 0;
    }
    
    @Predicate(Signature = "==/2", Template = {"?term,?term"}, Reference = "Term identical")
    @Determined
    public boolean predicateTermEqu(final Goal goal, final TermStruct predicate) {
        return predicate.getElement(0).termComparsion(predicate.getElement(1)) == 0;
    }
    
    @Predicate(Signature = "\\==/2", Template = {"?term,?term"}, Reference = "Term not identical")
    @Determined
    public boolean predicateNotTermEqu(final Goal goal, final TermStruct predicate) {
        return predicate.getElement(0).termComparsion(predicate.getElement(1)) != 0;
    }
    
    @Predicate(Signature = ">/2", Template = {"@evaluable,@evaluable"}, Reference = "Arithmetic greater than")
    @Determined
    public boolean predicateArithMore(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Determined
    public boolean predicateArithLess(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Determined
    public boolean predicateArithMoreOrEqu(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Determined
    public boolean predicateArithLessOrEqu(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Determined
    public boolean predicateArithNotEqu(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateXOR(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateBITWISENOT(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
    ...
    @Evaluable
    public  Term predicateBITWISEOR(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateBITWISEAND(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateMOD(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateREM(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicatePOWER(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateADDTWO(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateSIN(final Goal goal, final TermStruct predicate) {
    ...
    @Evaluable
    public  Term predicateFLOATINTEGERPART(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
    ...
    @Evaluable
    public  Term predicateFLOATFRACTIONALPART(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateFLOOR(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateTRUNCATE(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateROUND(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateCEILING(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateCOS(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateATAN(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateEXP(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateLOG(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateSQRT(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        final float value = arg.getNumericValue().floatValue();
    ...
    @Evaluable
    public  Term predicateABS(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
        return (Term) arg.abs();
    }
    ...
    @Evaluable
    public  Term predicateSIGN(final Goal goal, final TermStruct predicate) {
        final NumericTerm arg = calculatEvaluable(goal, predicate.getElement(0));
    ...
    @Evaluable
    public  Term predicateSUBTWO(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateNeg(final Goal goal, final TermStruct predicate) {
    ...
    @Evaluable
    public  Term predicateTheSame(final Goal goal, final TermStruct predicate) {
    ...
    @Evaluable
    public  Term predicateMUL(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateDIV(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateINTDIV(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateSHIFTLEFT(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Evaluable
    public  Term predicateSHIFTRIGHT(final Goal goal, final TermStruct predicate) {
        final NumericTerm left = calculatEvaluable(goal, predicate.getElement(0));
        final NumericTerm right = calculatEvaluable(goal, predicate.getElement(1));
    ...
    @Determined
    public boolean predicateIS(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public  void predicateTRUE(final Goal goal, final TermStruct predicate) {
    }
    
    @Predicate(Signature = "fail/0", Reference = "The predicate is always false.")
    @Determined
    public boolean predicateFAIL(final Goal goal, final TermStruct predicate) {
        return false;
    }
    ...
    @Determined
    public boolean predicateNOT(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    @Determined
    public boolean predicateEQU(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateNOTEQU(final Goal goal, final TermStruct predicate) {
        final Term left = predicate.getElement(0);
        final Term right = predicate.getElement(1);
        return !left.Equ(right);
    }
    ...
    @Determined
    public  void predicateCUT(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public  void predicateCUTLOCAL(final Goal goal, final TermStruct predicate) {
        // it is a stub function for embedded inside operator
    }
    
    @Predicate(Signature = "repeat/0", Reference = "repeat is true. It just places a choice point every call.")
    public  void predicateREPEAT(final Goal goal, final TermStruct predicate) {
    ...
    public boolean predicateCLAUSE(final Goal goal, final TermStruct predicate) {
    ...
    public boolean predicateCURRENTOP(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateOP(final Goal goal, final TermStruct predicate) {
    ...
    public boolean predicateCALL(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    @Determined
    public boolean predicateONCE(final Goal goal, final TermStruct predicate) throws InterruptedException {
        final Term argument = Utils.getTermFromElement(predicate.getElement(0));
    ...
    public final  void predicateOR(final Goal goal, final TermStruct predicate) throws InterruptedException {
        // it is a stub function for embedded inside operator
    }
    
    @Predicate(Signature = "->/2", Reference = "'->'(If, Then) is true if and only if If is true and Then is true for the first solution of If")
    @ItChangesGoalChain
    public final  boolean predicateIFTHEN(final Goal goal, final TermStruct predicate) throws InterruptedException {
        // if-then
    ...
    public  void predicateAND(final Goal goal, final TermStruct predicate) throws InterruptedException {
        // it is a stub function for embedded inside operator
    }
    
    @Predicate(Signature = "var/1", Reference = "var(X) is true if and only if X is a variable.")
    @Determined
    public boolean predicateVAR(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateNONVAR(final Goal goal, final TermStruct predicate) {
        final Term arg = predicate.getElement(0);
        if (arg.getTermType() == Term.TYPE_VAR) {
            return !((Var) arg).isUndefined();
        }
    ...
    @Determined
    public boolean predicateATOM(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateINTEGER(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateNUMBER(final Goal goal, final TermStruct predicate) {
        final Term arg = Utils.getTermFromElement(predicate.getElement(0));
    ...
    @Determined
    public boolean predicateFLOAT(final Goal goal, final TermStruct predicate) {
        final Term arg = Utils.getTermFromElement(predicate.getElement(0));
        if (arg.getTermType() == Term.TYPE_ATOM) {
    ...
    @Determined
    public boolean predicateCOMPOUND(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateATOMIC(final Goal goal, final TermStruct predicate) {
        final Term arg = Utils.getTermFromElement(predicate.getElement(0));
        boolean result = false;
        switch (arg.getTermType()) {
            case Term.TYPE_ATOM: {
    ...
    @Determined
    public boolean predicateARG(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateFUNCTOR(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateUNIV(final Goal goal, final TermStruct predicate) {
    ...
    private  boolean consultFromResource(String resource, ProlContext context, ProlStreamManager streamManager) {
        Reader reader = null;
        try {
    ...
    @Determined
    public boolean predicateCONSULT(final Goal goal, final TermStruct predicate) {
    ...
    private  NumericTerm calculatEvaluable(final Goal goal, Term term) {
        try {
    ...
    @Determined
    public boolean predicateATOMCHARS(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateCHARCODE(final Goal goal, final TermStruct predicate) {
        Term left = Utils.getTermFromElement(predicate.getElement(0));
        Term right = Utils.getTermFromElement(predicate.getElement(1));
    ...
    @Determined
    public boolean predicateNUMBERCODES(final Goal goal, final TermStruct predicate) {
        Term left = Utils.getTermFromElement(predicate.getElement(0));
        final Term right = Utils.getTermFromElement(predicate.getElement(1));
    ...
    @Determined
    public boolean predicateNUMBERCHARS(final Goal goal, final TermStruct predicate) {
        Term left = Utils.getTermFromElement(predicate.getElement(0));
        final Term right = Utils.getTermFromElement(predicate.getElement(1));
    ...
    public boolean predicateFOR(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateRND(final Goal goal, final TermStruct predicate) {
        final Term term = Utils.getTermFromElement(predicate.getElement(0));
    ...
    @Determined
    public boolean predicateATOMLENGTH(final Goal goal, final TermStruct predicate) {
        Term left = Utils.getTermFromElement(predicate.getElement(0));
        final Term right = Utils.getTermFromElement(predicate.getElement(1));
    ...
    @Determined
    public boolean predicateATOMCHARCODES(final Goal goal, final TermStruct predicate) {
        Term left = Utils.getTermFromElement(predicate.getElement(0));
        Term right = Utils.getTermFromElement(predicate.getElement(1));
    ...
    @Determined
    public  void predicateHALT(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateABOLISH(final Goal goal, final TermStruct predicate) {
        ...
        if (goal.getContext().hasPredicateAtLibraryForSignature(signature)) {
            throw new ProlPermissionErrorException("modify", "_procedure", new Term(signature));
        }
    ...
    @Determined
    @SuppressWarnings("unchecked")
    public boolean predicateSORT(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public boolean predicateFINDALL(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    @Determined
    public boolean predicateASSERTA(final Goal goal, final TermStruct predicate) {
        final KnowledgeBase base = goal.getContext().getKnowledgeBase();
        ...
        // check that we doesn't overload any  system predicate
        if (goal.getContext().hasPredicateAtLibraryForSignature(signature)) {
            throw new ProlPermissionErrorException("modify", "_procedure", new Term(signature));
        }
    ...
    @Determined
    public boolean predicateASSERTZ(final Goal goal, final TermStruct predicate) {
        final KnowledgeBase base = goal.getContext().getKnowledgeBase();
        Term atom = Utils.getTermFromElement(predicate.getElement(0));
    ...
    @Determined
    public boolean predicateRETRACT(final Goal goal, final TermStruct predicate) {
        final KnowledgeBase base = goal.getContext().getKnowledgeBase();
    ...
    @Determined
    public boolean predicateRETRACTZ(final Goal goal, final TermStruct predicate) {
        final KnowledgeBase base = goal.getContext().getKnowledgeBase();
    ...
    @Determined
    public boolean predicateRETRACTALL(final Goal goal, final TermStruct predicate) {
        final KnowledgeBase base = goal.getContext().getKnowledgeBase();
        Term atom = Utils.getTermFromElement(predicate.getElement(0));
    ...
    public boolean predicateCATCH(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    @Determined
    public  void predicateTHROW(final Goal goal, final TermStruct predicate) {
        final Term term = Utils.getTermFromElement(predicate.getElement(0));
    ...
    @Determined
    public  void predicateBEEP(final Goal goal, final TermStruct predicate) {
//        Toolkit.getDefaultToolkit().beep();
    }
    
    @Predicate(Signature = "pause/1", Template = {"+number"}, Reference = "Make a pause for defined millisecond number.")
    @Determined
    public  void predicatePAUSE(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    private  TermStruct processIterator(final Goal goal, final ClauseIterator iterator) {
    ...
    public boolean predicateFACTS(final Goal goal, final TermStruct predicate) {
    ...
    public boolean predicateRULES(final Goal goal, final TermStruct predicate) throws InterruptedException {
     ...
     */
    private  class AuxForkTask implements Callable<Term> {
    ...
    @Determined
    public  void predicateLOCK(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public  void predicateUNLOCK(final Goal goal, final TermStruct predicate) {
        final String atomName = predicate.getElement(0).getText();
    ...
    @Determined
    public boolean predicateTRYLOCK(final Goal goal, final TermStruct predicate) {
        final String atomName = predicate.getElement(0).getText();
    ...
    @Determined
    public  void predicateASYNC(final Goal goal, final TermStruct predicate) {
    ...
    @Determined
    public  void predicateWAITASYNC(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    @SuppressWarnings("unchecked")
    private  List<Future<Term>> startListAsFork(final Goal goal, final TermStruct predicate, final TermList termlist) throws InterruptedException {
    ...
    public boolean predicateFORK(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    public boolean predicateIFORK(final Goal goal, final TermStruct predicate) throws InterruptedException {
    ...
    @Determined
    public boolean predicateREGTRIGGER(final Goal goal, final TermStruct predicate) {
        final String signature = Utils.extractPredicateSignatureFromStructure((TermStruct) predicate.getElement(0));
