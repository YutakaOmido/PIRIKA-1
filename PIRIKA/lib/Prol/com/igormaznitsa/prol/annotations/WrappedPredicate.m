...
@implementation ComIgormaznitsaProlAnnotationsWrappedPredicate
@synthesize Name;
...
- (IOSClass *)annotationType {
  return [IOSClass classWithProtocol:@protocol(ComIgormaznitsaProlAnnotationsWrappedPredicate)];
}
...
+ (J2ObjcClassInfo *)__metadata {
  static J2ObjcClassInfo _ComIgormaznitsaProlAnnotationsWrappedPredicate = { "WrappedPredicate", "com.igormaznitsa.prol.annotations", NULL, 0x2201, 0, NULL, 0, NULL, 0, NULL};
  return &_ComIgormaznitsaProlAnnotationsWrappedPredicate;
}
